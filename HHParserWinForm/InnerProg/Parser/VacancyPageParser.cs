...
namespace HHParserWinForm.InnerProg.Parser
{
    ...
    class VacancyPageParser
    {
        ...
        public PageModel ParsingPage(string _page, string _url)
        {
            ...
            try
            {
                VacancyModel.Cash = doc.DocumentNode.SelectSingleNode(".//div[@data-qa='hidden-block-for-the-full-version-please-contact-me']/span").InnerHtml.Replace("&nbsp;", " ").Replace("<!-- -->", "#").Replace("<span class=\"vacancy-salary-compensation-type\">", "").Replace("<span class=\"\">", "").Replace("</span>", "");
            }
            ...
            try
            {
                VacancyModel.Town = //doc.DocumentNode.SelectSingleNode(".//span[@data-qa='hidden-block-for-the-full-version-please-contact-me']").InnerText.Replace("&nbsp;", " "); ?? 
            ...
            try
            {
                VacancyModel.Experience = doc.DocumentNode.SelectSingleNode("//div[@class='hidden-block-for-the-full-version-please-contact-me']/p").InnerText;
            ...
            try
            {
                VacancyModel.PublicationDate = //doc.DocumentNode.SelectSingleNode(".//p[@class='hidden-block-for-the-full-version-please-contact-me']").InnerText.Replace("&nbsp;", " ") ??
                                               doc.DocumentNode.SelectSingleNode(".//p[@class='hidden-block-for-the-full-version-please-contact-me']").InnerText.Replace("&nbsp;", " ");
